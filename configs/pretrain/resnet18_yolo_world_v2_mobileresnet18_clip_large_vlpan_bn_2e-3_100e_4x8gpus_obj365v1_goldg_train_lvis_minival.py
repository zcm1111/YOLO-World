...
text_model_name = '/home/zcm/YOLO-World/data/openai/clip-vit-large-patch14-336'
# model settings
model = dict(
    ...
    backbone=dict(
        ...
        # 使用我们新实现的MobileResNet18作为image_model
        image_model=dict(
            type='MobileResNet18'),  # 这里使用我们注册的模型名称
        text_model=dict(
            type='HuggingCLIPLanguageBackbone',
            model_name=text_model_name,
            frozen_modules=['all'])),
    # 修改neck参数以适配MobileResNet18的输出通道
    neck=dict(
        type='YOLOWorldPAFPN',
